...
export default function Header({ toggleSidebar }) {
  ...
  return (
    <section className="fixed w-full top-0 flex items-center gap-3 bg-white border-b px-4 py-3 z-[25]">
      <div className=" md:hidden flex justify-center items-center">
        <button onClick={toggleSidebar}>
          <Menu />
        </button>
      </div>
      <div className=" w-full flex justify-between items-center md:pr-[260px] pr-0">
