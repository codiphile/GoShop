...
export default function page() {
  ...
  return (
    <main className="p-7 flex flex-col gap-3 justify-center items-center">
      ...
      <div className="p-1 w-full md:max-w-[900px] gap-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 ">
